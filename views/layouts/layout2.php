...
<html lang="zh-cn">
	<head>
	    ...
	    <!-- Bootstrap Core CSS -->
	    <link rel="stylesheet" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/css/bootstrap.min.css">
	    
	    <!-- Customizable CSS -->
	    <link rel="stylesheet" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/css/main.css">
	    <link rel="stylesheet" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/css/red.css">
	    <link rel="stylesheet" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/css/owl.carousel.css">
		<link rel="stylesheet" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/css/owl.transitions.css">
		<link rel="stylesheet" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/css/animate.min.css">

		
		<!-- Icons/Glyphs -->
		<link rel="stylesheet" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/css/font-awesome.min.css">
		
		<!-- Favicon -->
		<link rel="shortcut icon" href="http://ltfnevergiveup.cn/yii2_shop/web/assets/images/favicon.ico">

		<!-- HTML5 elements and media queries Support for IE8 : HTML5 shim and Respond.js -->
		<!--[if lt IE 9]>
			<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/html5shiv.js"></script>
			<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/respond.min.js"></script>
		<![endif]-->
...
<a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">
		<img alt="logo" src="http://ltfnevergiveup.cn/yii2_shop/web/assets/images/logo.PNG" width="233" height="54"/>
	</a>
</div><!-- /.logo -->
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                ...
                <span class="count"><?php echo count($this->params['cart']['products']) ?></span>
                    <img src="http://ltfnevergiveup.cn/yii2_shop/web/assets/images/icon-cart.png" alt="" />
                </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="http://ltfnevergiveup.cn/yii2_shop/web/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="http://ltfnevergiveup.cn/yii2_shop/web/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="http://ltfnevergiveup.cn/yii2_shop/web/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="http://ltfnevergiveup.cn/yii2_shop/web/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
<!-- ============================================================= FOOTER : END ============================================================= -->	</div><!-- /.wrapper -->
	...
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/jquery-1.10.2.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/jquery-migrate-1.2.1.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/bootstrap.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/gmap3.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/bootstrap-hover-dropdown.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/owl.carousel.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/css_browser_selector.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/echo.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/jquery.easing-1.3.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/bootstrap-slider.min.js"></script>
    <script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/jquery.raty.min.js"></script>
    <script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/jquery.prettyPhoto.min.js"></script>
    <script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/jquery.customSelect.min.js"></script>
    <script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/wow.min.js"></script>
	<script src="http://ltfnevergiveup.cn/yii2_shop/web/assets/js/scripts.js"></script>
